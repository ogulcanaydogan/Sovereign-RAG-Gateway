...
| `gateway_chart_version` | `0.8.0-beta.1` | Helm chart/app release version |
| `gateway_image_tag` | `v0.8.0-beta.1` | Gateway image tag |
...
gateway_image_tag    = "v0.8.0-beta.1"
gateway_chart_version = "0.8.0-beta.1"
gateway_replicas     = 3
