...
| `gateway_chart_version` | `0.6.0` | Helm chart/app release version |
| `gateway_image_tag` | `v0.6.0` | Gateway image tag |
...
gateway_image_tag    = "v0.6.0"
gateway_chart_version = "0.6.0"
gateway_replicas     = 3
