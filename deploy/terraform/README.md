...
| `gateway_chart_version` | `0.7.0-alpha.2` | Helm chart/app release version |
| `gateway_image_tag` | `v0.7.0-alpha.2` | Gateway image tag |
...
gateway_image_tag    = "v0.7.0-alpha.2"
gateway_chart_version = "0.7.0-alpha.2"
gateway_replicas     = 3
