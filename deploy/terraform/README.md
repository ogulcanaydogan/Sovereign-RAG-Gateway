...
| `gateway_chart_version` | `0.7.0` | Helm chart/app release version |
| `gateway_image_tag` | `v0.7.0` | Gateway image tag |
...
gateway_image_tag    = "v0.7.0"
gateway_chart_version = "0.7.0"
gateway_replicas     = 3
