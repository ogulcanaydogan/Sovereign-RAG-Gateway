...
| `gateway_chart_version` | `0.9.0-rc1` | Helm chart/app release version |
| `gateway_image_tag` | `v0.9.0-rc1` | Gateway image tag |
...
gateway_image_tag    = "v0.9.0-rc1"
gateway_chart_version = "0.9.0-rc1"
gateway_replicas     = 3
